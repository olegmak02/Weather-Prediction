...
model_path = 'dew.keras'
window_size = 9
column_name = 'dew_point_2m (°C)'
...
joblib.dump(scaler_X, '..\\scalers\\dew.pkl')
...
if not os.path.exists(model_path):
    ...
    model.fit(X_train, y_train, epochs=80, batch_size=3, verbose=1)
...
plt.title('Neural Network Dew Point Predictions')
plt.legend()
plt.show()
